...
public class RplISupport : BaseIrcCommand
{
    ...
    /// </summary>
    public List<string> SupportTokens { get; set; } = new List<string>();
    ...
    public override void Parse(string line)
    {
        ...
        int endIndex = lastPartIndex > 0 ? lastPartIndex : parts.Length;
    ...
    public override string Write()
    {
        ...
        string tokens = string.Join(" ", SupportTokens);
