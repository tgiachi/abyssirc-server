...
/// </summary>
public class RplEndOfInfoCommand : BaseIrcCommand
{
    /// <summary>
    ...
    public RplEndOfInfoCommand() : base("374")
    {
    }
    ...
    public static RplEndOfInfoCommand Create(
        string serverName,
        string nickname,
        string message = null
    )
    {
        return new RplEndOfInfoCommand
        {
